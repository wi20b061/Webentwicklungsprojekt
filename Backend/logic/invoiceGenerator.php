...
class InvoiceGenerator{
    public function generateInvoice($user, $saleslineList, $sumamount, $orderDate, $invoiceNo){
        ...
        $pdf->addNumTVA("ATU12345678");
        //
        $pdf->Cell(100,10,'Item',"RB",0,"C");
        $pdf->Cell(30,10,'Amount',"RBL",0,"C");
        $pdf->Cell(30,10,'Price',"RBL",0,"C");
        $pdf->Cell(30,10,'Total',"BL",1,"C");

        echo $saleslineList[0]->get_productName();

        $pdf->SetFont('Arial', '', 12);
        //renders actual invoice table
            $pdf->Cell(100,8,$saleslineList[0]->get_productName(),1,0);
            $pdf->Cell(30,8,$saleslineList[0]->get_quantity(),1,0,"R");
            $pdf->Cell(30,8,sprintf("%00.2f",$saleslineList[0]->get_productprice()/100),1,0,"R");
            $pdf->Cell(30,8,sprintf("%00.2f",$sumamount),1,1,"R");
        

        // //renders actual invoice table
        // foreach ($keys as $key){
        //     $pdf->Cell(100,8,$products[$key],1,0);
        //     $pdf->Cell(30,8,$amounts[$key],1,0,"R");
        //     $pdf->Cell(30,8,sprintf("%00.2f",$prices[$key]/100),1,0,"R");
        //     $pdf->Cell(30,8,sprintf("%00.2f",$prices[$key]/100*$amounts[$key]),1,1,"R");
        // }
        //
/*
