        ...
        <main class="pt-1 pb-1 ps-5 pe-5 mt-1">
            ...
            <div class="row">
                ...
                <div class="col border-start">
                    ...
                    <div class="row m-1">
                        <button type="button" id="btnOrder" class="btn btn-dark m-2" style="background-color: #365370;">Order <i class="bi bi-check-lg ms-1" style="font-size: 1.5rem; color: white;"></i></button>
                    </div>
                </div>
            </div>
