    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        if(isset($_SESSION["userID"])){
          echo "<li class='nav-item'><a class='nav-link' href='login.html'>Logout</a></li>";
          ...
          echo "<li class='nav-item'><a class='nav-link' href='meinKonto.html'>Mein Konto</a></li>";
        }
          //Sollte User nicht eingeloggt sein, werden ihm nur Register und Login angezeigt.
        else{
          echo "<li class='nav-item'><a class='nav-link' href='registration.html'>Register</a></li>";
          echo "<li class='nav-item'><a class='nav-link' href='login.html'>Login</a></li>";
          echo "<li class='nav-item'><i class='bi bi-basket-fill' style='font-size: 1.5rem; color: black;'></i></li>";
        }
        ?>
      </ul>
      <?php
